...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Org mode
   `(org-level-1                    ((,class (:foreground ,red-3 :weight bold))))
   `(org-level-2                    ((,class (:foreground ,blue-3 :weight bold))))
   ...
   `(org-agenda-date                ((,class (:foreground ,blue-3))))
   `(org-agenda-date-today          ((,class (:foreground ,blue-3 :weight bold))))
   `(org-agenda-date-weekend        ((,class (:foreground ,blue-3))))
   `(org-agenda-structure           ((,class (:foreground ,blue-3))))
   `(org-scheduled                  ((,class (:foreground ,black))))
   `(org-scheduled-previosly        ((,class (:foreground ,black))))
   `(org-scheduled-today            ((,class (:foreground ,black))))
   `(org-upcoming-deadline          ((,class (:foreground ,black))))
   `(org-warning                    ((,class (:foreground ,black))))
   ;; Mu4e
